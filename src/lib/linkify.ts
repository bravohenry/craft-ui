/**
 * [INPUT]: linkify-it (URL detection library)
 * [OUTPUT]: DetectedLink, detectLinks, preprocessLinks, hasLinks
 * [POS]: lib/ — URL and file path detection for markdown preprocessing
