/**
 * [INPUT]: Depends on @/types/activity for ActivityItem, @/components/terminal/TerminalOutput for ToolType
 * [OUTPUT]: ReadResult, parseReadResult, BashResult, parseBashResult, GrepResult, parseGrepResult,
 *           GlobResult, parseGlobResult, parseWebSearchResult, CodeOverlayData, TerminalOverlayData,
 *           GenericOverlayData, JSONOverlayData, DocumentOverlayData, OverlayData, extractOverlayData
 * [POS]: lib/ — Tool output parsing utilities for chat message rendering
