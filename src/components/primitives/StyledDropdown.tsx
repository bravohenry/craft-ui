/**
 * [INPUT]: react, @radix-ui/react-dropdown-menu, @/utils/cn
 * [OUTPUT]: DropdownMenu, DropdownMenuTrigger, DropdownMenuSub, StyledDropdownMenuContent, StyledDropdownMenuItem, StyledDropdownMenuSeparator, StyledDropdownMenuSubTrigger, StyledDropdownMenuSubContent, DropdownMenuShortcut
 * [POS]: primitives/ — Radix-based styled dropdown menu with sub-menu support
