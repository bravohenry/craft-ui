/**
 * [INPUT]: @/utils/cn, @/components/markdown (Markdown)
 * [OUTPUT]: SystemMessage, SystemMessageProps, SystemMessageType
 * [POS]: chat/ — system/info/error/warning message display with type-based styling
