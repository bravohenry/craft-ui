/**
 * [INPUT]: @radix-ui/react-dropdown-menu, @radix-ui/react-context-menu, lucide-react, @/context/PlatformContext, @/utils/cn, ../primitives/PreviewHeader
 * [OUTPUT]: FullscreenOverlayBaseHeader component, OverlayTypeBadge type, FullscreenOverlayBaseHeaderProps type
 * [POS]: overlay/ header bar — badge row with dual-trigger file path menu, consumed by FullscreenOverlayBase and PreviewOverlay
...
import { PreviewHeader, PreviewHeaderBadge, type PreviewBadgeVariant } from '../primitives/PreviewHeader'
