/**
 * [INPUT]: PreviewOverlay, ContentFrame (sibling), ShikiCodeViewer (@/components/code-viewer), lucide-react icons
 * [OUTPUT]: CodePreviewOverlay component, CodePreviewOverlayProps interface
 * [POS]: overlay/ — Code file preview overlay for Read/Write tools with syntax highlighting
...
import { ShikiCodeViewer } from '@/components/code-viewer/ShikiCodeViewer'
