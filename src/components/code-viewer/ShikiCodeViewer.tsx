/**
 * [INPUT]: shiki (codeToHtml, bundledLanguages), @/utils/cn, @/lib/language-map
 * [OUTPUT]: ShikiCodeViewer, ShikiCodeViewerProps
 * [POS]: code-viewer/ — read-only code viewer with Shiki syntax highlighting + line numbers
