/**
 * [INPUT]: @pierre/diffs (FileDiff, parseDiffFromFile, DIFFS_TAG_NAME), @/utils/cn, @/lib/language-map, ./registerShikiThemes
 * [OUTPUT]: ShikiDiffViewer, ShikiDiffViewerProps, getDiffStats
 * [POS]: code-viewer/ — Shiki-based split/unified diff viewer using @pierre/diffs
