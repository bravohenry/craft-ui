/**
 * [INPUT]: depends on @/types/activity, @/types/message, @/utils/cn, @/utils/paths, @/components/primitives, @/components/overlay, @/components/code-viewer, @/components/markdown, ./turn-utils, ./AcceptPlanDropdown, ./TurnCardActionsMenu
 * [OUTPUT]: exports SIZE_CONFIG, ActivityStatusIcon, ResponseCard, TurnCard, TurnCardProps, ResponseCardProps, and re-exports activity types
 * [POS]: chat/ — Main turn card component for rendering assistant responses with activities, tools, and content
 * [PROTOCOL]: Update this header on change, then check AGENTS.md
 */
import * as React from 'react'
import { useMemo, useEffect, useRef, useCallback, useState } from 'react'
import type { ToolDisplayMeta } from '@/types/message'
import type { ActivityItem, ActivityStatus, ActivityType, ResponseContent, TodoItem, TodoStatus } from '@/types/activity'
import { normalizePath, pathStartsWith, stripPathPrefix } from '@/utils/paths'
...
import { Spinner } from '@/components/primitives/LoadingIndicator'
import { Tooltip, TooltipTrigger, TooltipContent } from '@/components/primitives/Tooltip'
import { parseDiffFromFile, type FileContents } from '@pierre/diffs'
import { getDiffStats, getUnifiedDiffStats } from '@/components/code-viewer'
...
import { DocumentFormattedMarkdownOverlay } from '@/components/overlay'
...
// Types (re-exported from @/types/activity)
// ============================================================================
export type { ActivityStatus, ActivityType, TodoStatus, TodoItem, ActivityItem, ResponseContent } from '@/types/activity'
