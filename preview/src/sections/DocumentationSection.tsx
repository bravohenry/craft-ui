        ...
        <CardContent className="space-y-5">
          ...
          <div className="space-y-3 rounded-lg border border-border bg-muted/20 p-3">
            ...
            <UserMessageBubble
              ...
              content="If shadcn already works, why build an Agentic-Native UI Kit?"
            />
            <SystemMessage
              className="px-0 py-0"
              type="system"
              content="Story: we started with [shadcn/ui](https://github.com/shadcn-ui/ui) primitives for standard app UI. As soon as the product became agentic, we needed first-class interfaces for thinking-process traces, long-form Markdown output, and Mermaid diagrams generated by models. Those are core workflows, not edge cases. This kit keeps shadcn-style composability and adds production patterns extracted from [Craft Agents OSS](https://github.com/lukilabs/craft-agents-oss/)."
            />
            <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
              <li>Shadcn gives excellent primitives for generic application UI.</li>
              <li>Agentic-Native adds workflow UI for thinking process, Markdown, and Mermaid.</li>
              <li>Result: one coherent system for React + Electron with less design drift.</li>
            </ul>
          </div>
