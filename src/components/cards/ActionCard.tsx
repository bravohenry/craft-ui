/**
 * [INPUT]: depends on @/utils/cn for class merging, lucide-react for Copy/Check icons
 * [OUTPUT]: exports ActionCard component, ActionCardProps, ActionCardAction types
 * [POS]: cards/ primary component — themed card with header, scrollable content, action footer
