/**
 * [INPUT]: None (pure data + functions)
 * [OUTPUT]: LANGUAGE_MAP, getLanguageFromPath, formatFilePath, truncateFilePath
 * [POS]: lib/ — file extension → language ID mapping for syntax highlighting
