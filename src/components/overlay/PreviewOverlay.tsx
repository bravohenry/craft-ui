/**
 * [INPUT]: react-dom, lucide-react, @/lib/layout, ./FullscreenOverlayBase, ./FullscreenOverlayBaseHeader, ./OverlayErrorBanner, ../primitives/PreviewHeader
 * [OUTPUT]: PreviewOverlay component, PreviewOverlayProps type, BadgeVariant type
 * [POS]: overlay/ presentation layer — unified modal/fullscreen/embedded overlay, consumed by GenericOverlay, ImagePreviewOverlay, and composed overlays
...
import type { PreviewBadgeVariant } from '../primitives/PreviewHeader'
