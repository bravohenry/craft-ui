/**
 * [INPUT]: shiki (codeToHtml, bundledLanguages), @/utils/cn, @/context/ShikiThemeContext
 * [OUTPUT]: CodeBlock, InlineCode components, CodeBlockProps
 * [POS]: markdown/ — syntax highlighted code block using Shiki, consumed by Markdown renderer
...
export function CodeBlock({ code, language = 'text', className, mode = 'full', forcedTheme }: CodeBlockProps) {
  ...
  React.useEffect(() => {
    ...
    async function highlight() {
      // Theme priority: context > forcedTheme > DOM detection
      let theme: string
