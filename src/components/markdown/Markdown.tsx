/**
 * [INPUT]: react, react-markdown, rehype-raw, remark-gfm, @/utils/cn, @/lib/linkify, ./CodeBlock, ./MarkdownDiffBlock, ./MarkdownJsonBlock, ./MarkdownMermaidBlock, ./MarkdownDatatableBlock, ./MarkdownSpreadsheetBlock, ./remarkCollapsibleSections, ./CollapsibleSection, ./CollapsibleMarkdownContext, ./safe-components
 * [OUTPUT]: Markdown component, MemoizedMarkdown, RenderMode, MarkdownProps
 * [POS]: markdown/ — main markdown renderer with mode-based rendering (terminal/minimal/full), consumed by chat UI
...
import { preprocessLinks } from '@/lib/linkify'
