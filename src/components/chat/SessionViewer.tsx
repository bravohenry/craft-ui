/**
 * [INPUT]: depends on @/types/session, @/utils/cn, @/lib/layout, @/context/PlatformContext, ./TurnCard, ./UserMessageBubble, ./SystemMessage, ./turn-utils
 * [OUTPUT]: exports SessionViewer, SessionViewerProps, SessionViewerMode
 * [POS]: chat/ — Read-only session transcript viewer for web viewer app
