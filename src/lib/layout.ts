/**
 * [INPUT]: react (useState, useEffect)
 * [OUTPUT]: OVERLAY_LAYOUT, CHAT_LAYOUT, CHAT_CLASSES, OverlayMode, useOverlayMode
 * [POS]: lib/ — shared layout constants & responsive overlay hook for chat UI
