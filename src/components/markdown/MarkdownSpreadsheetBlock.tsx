/**
 * [INPUT]: react, lucide-react, @/utils/cn, @/hooks/useScrollFade, @/context/PlatformContext, ./CodeBlock, ../overlay/DataTableOverlay, ./TableExportDropdown
 * [OUTPUT]: MarkdownSpreadsheetBlock component, MarkdownSpreadsheetBlockProps
 * [POS]: markdown/ — Excel-style grid for ```spreadsheet code blocks, falls back to CodeBlock
