/**
 * [INPUT]: @/utils/cn, ./DiffIcons
 * [OUTPUT]: DiffViewerControls, DiffViewerControlsProps
 * [POS]: code-viewer/ — header control bar for diff viewer (stats + style toggle + background toggle)
