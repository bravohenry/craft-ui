/**
 * [INPUT]: PreviewOverlay (sibling), CopyButton (@/components/primitives), react-pdf, pdfjs-dist, lucide-react icons
 * [OUTPUT]: PDFPreviewOverlay component, PDFPreviewOverlayProps interface
 * [POS]: overlay/ — In-app PDF preview using Mozilla's pdf.js via react-pdf
