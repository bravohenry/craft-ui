/**
 * [INPUT]: @pierre/diffs (FileDiff, parsePatchFiles, DIFFS_TAG_NAME), @/utils/cn, @/lib/language-map
 * [OUTPUT]: UnifiedDiffViewer, UnifiedDiffViewerProps, getUnifiedDiffStats
 * [POS]: code-viewer/ — diff viewer for pre-computed unified diff strings (e.g. Codex patches)
